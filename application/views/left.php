      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          ...
          <!-- <li class="nav-item"> <a class="nav-link" href="/user?pages=1&limit=10">客户信息</a></li> -->
            ...
            <li class="nav-item"> <a class="nav-link" href="/dept?pages=1&limit=10">部门管理</a></li>
            <li class="nav-item"> <a class="nav-link" href="/role?pages=1&limit=10">权限管理</a></li>
            <li class="nav-item"> <a class="nav-link" href="/cmenu?pages=1&limit=10">菜单管理</a></li>
          </ul>
        </div>
      </li>
