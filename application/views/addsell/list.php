...
<!--        <button class="layui-btn" onclick="x_admin_show('添加','/addsell/add',600,400)"><i class="layui-icon"></i>添加</button>-->
...
<!--                <td>--><?//=$item['type']?><!--</td>-->
                ...
                <td class="td-manage">
					...
					<span class="layui-btn layui-btn-normal layui-btn-mini"   onclick="x_admin_show('编辑','/addsell/edit?id=<?=$item['id']?>',600,400)">
					编辑</span>



					<button type="button" class="layui-btn layui-btn-sm layui-btn-normal" onclick="member_del(this,<?=$item['id']?>)"><i class="layui-icon"></i> 删除</button>
