...
<!-- 
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_addtime" name="addtime" required="" lay-verify="addtime"
						   autocomplete="off" class="layui-input" placeholder="yyyy-MM-dd HH:mm:ss"  value='<?=$info->addtime?>' readonly="readonly">
				</div>
			</div> -->
