  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="d-flex">
                    ...
                    <p class="text-primary mb-0 hover-cursor">权限管理</p>
                  </div>
                </div>
                  <div class="d-flex justify-content-between align-items-end flex-wrap">
                      ...
                      <button type="button" class="btn btn-light bg-white btn-icon mr-3 mt-2 mt-xl-0" onclick="x_admin_show('新增','/role/add?>',600,400)">
      ...
      <div class="col-lg-12 grid-margin stretch-card">
            ...
            <td>
              <label class="badge badge-info" onclick="x_admin_show('编辑','/role/edit?id=<?=$item['id']?>',600,400)">编辑</label>

              <!-- <label class="badge badge-success" onclick="x_admin_show('修改密码','/role/cpass?id=<?=$item['id']?>',600,400)">修改密码</label> -->
                 ...
                 $.ajax({
                    ...
                    success:function(data){//res为相应体,function为回调函数
                        ...
                        if(data.status=="true"){
                              ...
                              layer.msg('ID:'+id+'该权限已删除!',{icon:1,time:1000});
